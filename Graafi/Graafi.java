        ...
        switch (metodi) {
            ...
            case PIENINVIRITTAVA:
                ...
                do{
                    ...
                    while( pieninKaari !=  null && solmuTaulu[pieninKaari.loppuSolmu().piste().y()][pieninKaari.loppuSolmu().piste().x()]){
                        pieninKaari = (Kaari) kaariLista.poll();
                    }
                    // jos kaari ei null niin lisätään uudet osat grafiin
                    if(pieninKaari != null){
